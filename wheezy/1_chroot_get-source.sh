...
if [ ! -d "$KERNEL_PATH" ]; then
	...
	cd $_
	git init
	echo git svn init --prefix=svn/ -T dists/trunk/linux -b dists/wheezy-backports/linux -t releases/linux svn://svn.debian.org/kernel
	git svn init --prefix=svn/ -T dists/trunk/linux -b dists/wheezy-backports/linux -t releases/linux svn://svn.debian.org/kernel
